...
const Skills: React.FC = () => {
  ...
  const professionalSkills = [
    ...
    },
    {
      ...
      level: 98,
      color: 'from-blue-400 to-blue-600',
      description: 'Native-level fluency in speaking, writing, and professional communication',
    },
    {
      name: 'Tamil',
      category: 'languages',
      ...
      description: 'Native language with deep cultural understanding',
    },
    {
      name: 'Arabic',
      category: 'languages',
      level: 80,
      color: 'from-green-400 to-green-600',
      description: 'Proficient in reading, writing, and conversational Arabic',
    },
    {
      name: 'Spanish',
      category: 'languages',
      ...
      description: 'Intermediate conversational Spanish with growing vocabulary',
    },
    {
      name: 'Docker & CI/CD',
      category: 'automation',
  ...
  const personalSkills = [
    {
      ...
      level: 98,
      color: 'from-blue-400 to-blue-600',
      description: 'Eloquent communicator with nuanced understanding of cultural contexts',
    },
    {
      name: 'Tamil',
      category: 'languages',
      level: 100,
      color: 'from-orange-400 to-orange-600',
      description: 'Native speaker with deep appreciation for linguistic beauty',
    },
    {
      name: 'Arabic',
      category: 'languages',
      level: 80,
      color: 'from-green-400 to-green-600',
      description: 'Strong foundation in classical and modern standard Arabic',
    },
    {
      name: 'Spanish',
      category: 'languages',
      level: 70,
      color: 'from-red-400 to-red-600',
      description: 'Passionate learner connecting with Hispanic cultures',
    },
    {
      name: 'French',
      category: 'languages',
      ...
      description: 'Basic proficiency with enthusiasm for French culture',
    },
    {
      ...
      description: 'Natural ability to understand and share feelings of others deeply',
    },
    {
      ...
      description: 'Exceptional awareness and management of own and others\' emotions',
    },
    {
